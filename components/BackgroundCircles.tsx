...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="rounded-full border border-[#333333] h-[651px] w-[651px] absolute mt-52" />
      <div className="rounded-full border border-[#333333] h-[650px] w-[650px] absolute mt-52" />
      <div className="rounded-full border border-[#edbf5b] opacity-10 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
